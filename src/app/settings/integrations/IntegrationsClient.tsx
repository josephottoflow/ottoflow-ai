...
import { HardDrive, Check, AlertTriangle, Loader2, Plug, FolderTree } from "lucide-react";
  ...
  return (
    <div className="p-6 max-w-[900px] mx-auto">
      ...
      <p className="text-white/30 text-xs mt-6">
        More integrations (LinkedIn, Facebook, Instagram, and others) are coming in later phases.
      </p>
    </div>
  );
}
